		...
		<div class="cart-box">
			...
			<div v-if="count>0" class="cart-bottom-bg fix-bottom">
				<div class="cart-bar-operation">
					<div>
						<div class="choose-all js-choose-all">
							<span class="blue-checkbox-new" :class="{'checkbox-on':allChecked}" @click="allCheckGoodsHandle(allChecked)"><a></a></span> 全选
						</div>
				...
				<div class="shipping">
					...
					<router-link class="jianguo-blue-main-btn big-main-btn js-checkout" :class="{'disabled-btn':checkedCount<=0}" to="/checkout" tag="span" @click="checkOutHandle"><a>现在结算</a></router-link>
				</div>
			</div>
		</div>
	</div>
