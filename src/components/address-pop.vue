                ...
                <div class="address-form">
                  ...
                  <div class="module-form-row">
                    <div class="form-item-v3" :class="{'form-invalid-item':phoneError}">
                      <input type="text" class="js-verify" placeholder="手机号" v-model="receive.phone" @blur="inspectPhone" @focus="setPhoneError">
                      <div class="verify-error"></div>
                    </div>
                  </div>
...
export default {
    ...
    methods: {
        ...
        inspectPhone () {
            let re = /\d/
            if (this.receive.phone.length === 11 && re.test(this.receive.phone)) {
